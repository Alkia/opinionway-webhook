    ...
    for segment in transcript_segments:
        ...
        for theme in themes_of_interest:
            ...
            if any(keyword.lower() in normalized_text for keyword in theme['keywords']):
                opinion = text.strip()
                # Use LLM to summarize the opinion
                ...
                result.append({"theme": summarized_theme, "opinion": summarized_opinion, "classification": classification})
...
print(json.dumps(themes_and_opinions, indent=2))
